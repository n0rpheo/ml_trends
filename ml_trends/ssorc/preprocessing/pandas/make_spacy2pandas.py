...
wordDF.to_pickle(os.path.join(path_to_pandas, 'word.pandas'))
lemmaDF.to_pickle(os.path.join(path_to_pandas, 'lemma.pandas'))
fineposDF.to_pickle(os.path.join(path_to_pandas, 'finepos.pandas'))
coarseposDF.to_pickle(os.path.join(path_to_pandas, 'coarsepos.pandas'))
ent_typeDF.to_pickle(os.path.join(path_to_pandas, 'ent_type.pandas'))
merged_ent_typeDF.to_pickle(os.path.join(path_to_pandas, 'merged_ent_type.pandas'))
merged_wordDF.to_pickle(os.path.join(path_to_pandas, 'merged_word.pandas'))
